...
<template>
    <div class="space-y-6">
        ...
        <div class="space-y-4 rounded-lg border border-red-500 p-4 dark:border-red-200/10 dark:bg-red-700/10 dark:text-red-100">
            ...
            <DialogContent>
                <form class="space-y-6" @submit="deleteUser">
                    <DialogHeader class="space-y-3">
                        ...
                        <DialogDescription>
                            Una vez que la cuenta sea eliminada, todos sus recursos y datos también serán eliminados permanentemente. Por favor, ingresa tu contraseña para confirmar que deseas eliminar tu cuenta de forma permanente.
                        </DialogDescription>
                    </DialogHeader>
